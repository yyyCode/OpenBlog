<template>
  <div class="blog-container bugs-page">
    <div class="page-header">
      <h1 class="page-title">Bug 案例</h1>
      <p class="page-subtitle">项目开发过程中踩过的坑，问题排查与解决记录</p>
    </div>
...
async function load() {
  ...
  try {
    ...
    page.value = p
    const resp = await fetchArticlesByType('BUG_CASE', { page: p, size })
...
/* ArticleCard content larger on bug cases page */
